generate_parking_events_large.py
...
Save the script as generate_parking_events_large.py.

Run it in your terminal with:

python generate_parking_events_large.py
It will generate parking_events_large.csv with 1 million records.